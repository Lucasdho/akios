...
cat <<'EOF'
[agentic-kit · Swift/iOS] Always on: superpowers · ponytail · axiom.
...
- Implementing code      -> ponytail (no over-build/rewrite) + axiom (domain skill) + fewer-permission-prompts
- Creating SwiftUI Views -> native first + axiom->axiom-swiftui (with ponytail)
