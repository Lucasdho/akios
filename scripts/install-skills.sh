...
SKILLS=(idea-to-spec oss-first ios-feature-pipeline ios-agentic-kit spec-to-tasks task-execution swift-dev deep-brainstorm founderlens-behavior align-ui)
