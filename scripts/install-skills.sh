...
SKILLS=(idea-to-spec oss-first ios-feature-pipeline ios-agentic-kit spec-to-tasks task-execution swift-dev deep-brainstorm founderlens-behavior align-ui ui-variations knowledge-ingest just-vibes handoff skill-author data-modeling-canvas)
