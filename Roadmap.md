...
| alva-architecture-doctrine.md | Agent-Legible Vertical Architecture — portable doctrine (Part I) + akios impl (Part II) | designed | backlog B7–B12; publishable standalone; adopted via alva-adoption.md |
| alva-adoption.md | ALVA adoption + reconciliation with the UI family; ordered build backlog | designed | backlog B7–B12,B14,B10; v1.1 — **fork resolved 2026-07-01, ALVA confirmed**; `spec-to-tasks`-ready |
