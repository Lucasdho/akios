...
| alva-architecture-doctrine.md | Agent-Legible Vertical Architecture — portable doctrine (Part I) + akios impl (Part II) | planned | backlog B7–B12; publishable standalone; adopted via alva-adoption.md; tasks T001–T011 in tasks/todo/ |
| alva-adoption.md | ALVA adoption + reconciliation with the UI family; ordered build backlog | planned | backlog B7–B12,B14,B10; v1.1 — fork resolved 2026-07-01, ALVA confirmed; decomposed into tasks/todo/T001–T011 (v0.8.0 session 1) |
