...
| akios-footprint-consolidation.md | Consolidates akios's generated housekeeping (Context.md/Roadmap.md/Vision.md/workflow.yml/specs/tasks/archive/code-references/runtime journal) into one root-level `akios/` folder; reopens and narrows init-reliability-and-ux.md's footprint decision (D5) | planned | reopens B35; supersedes init-reliability-and-ux.md §5 only, §§1-4/6-11 there stand; backlog T058-T073 (7 checkpoints, CP1-CP6 + release) written 2026-07-03, includes self-migrating this repo's own root (T072, user-confirmed scope expansion beyond the spec's consumer-repo-only text) |
