...
| init-reliability-and-ux.md | `/akios:init` narration, per-action verification, per-file chmod policy, bounded retry, footprint consolidation | done | backlog B33-B35; realized via T055-T056 (v0.8.0 session 3c); durable manifest-file idea deliberately left open (§11); version bump deferred to the v0.8.0 closeout |
